        ...
        >
          ...
          <el-form-item label="选择身份">
            <el-select v-model="registerUser.identity" placeholder="请选择身份">
              <el-option laber="管理员" value="manager">管理员</el-option>
              <el-option laber="员工" value="employee">员工</el-option>
            </el-select>
          </el-form-item>
          <el-form-item>
...
export default {
  ...
  data() {
      ...
      return {
          ...
          rules:{
              name:[  //表单的验证 姓名, 邮箱,密码等
                  {required : true, message:'用户名不能为空',trigger:'blur'},// blur,失去焦点触发
              ...
              password2:[
                  { required: true, message: '密码不能为空',trigger: 'blur'},
                  {min : 6, max : 30, message:'长度在6到30之间',trigger:'blur'},
                  {validator: validatePass2, trigger: 'blur'}//第二次密码的校验
              ]
          }
      }
  },
